...
- [Unity 공식 First Person Controller 문서](https://docs.unity3d.com/Manual/FirstPersonController.html)
- [Input System vs Legacy Input 비교](https://learn.unity.com/tutorial/input-system-vs-input-manager)
