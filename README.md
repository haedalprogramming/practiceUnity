...
| **6. 3D 게임플레이 & UI**        | • [Rigidbody vs Character Controller](Day6/6-1.RigidbodyvsCharacterController.md)<br>• [Trigger & Collider 활용](Day6/6-2.Trigger&Collider활용.md)                                                         | • [Cinemachine 카메라 시스템](Day6/6-3.Cinemachine카메라시스템.md)<br>• [UI Toolkit vs Canvas 비교]()<br>• [게임 루프 설계 흐름]()                                 | • [실습: 3D 미션 2종 제작 (점프/수집)]()<br>• [UI 연동 및 게임 루프 구현]()                       | ✔ 3D 미션 2개 클리어 가능<br>✔ UI 연동 체크 + PR                               |
