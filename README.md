...
| **7. 성능 최적화 & 포트폴리오 정리**    | • [성능 분석 개념(Profiler)]()<br>• [Draw Call 최적화 기본]()<br>• [Addressables 개념]()                                                                | • [Addressables·빌드 플랫폼(Android/PC)]()                               | • [Notion Case Study · Velog 회고 작성]()                     | ✔ 빌드 사이즈 < 100 MB<br>✔ 포트폴리오 초안                 |
