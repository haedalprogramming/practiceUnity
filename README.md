...
| **6. 3D 게임플레이 & UI**        | • [Rigidbody vs Character Controller](Day6/6-1.RigidbodyvsCharacterController.md)<br>• [Trigger & Collider 활용]()                                                         | • [Cinemachine 카메라 시스템]()<br>• [UI Toolkit vs Canvas 비교]()<br>• [게임 루프 설계 흐름]()                                 | • [실습: 3D 미션 2종 제작 (점프/수집)]()<br>• [UI 연동 및 게임 루프 구현]()                       | ✔ 3D 미션 2개 클리어 가능<br>✔ UI 연동 체크 + PR                               |
