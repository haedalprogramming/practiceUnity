...
| **5. 3D 기초 & 씬 제작**         | • [3D 좌표계 이해]()<br>• [프리팹 개념과 활용](./Day4/4-3-1.빌드경량화설정연습.md)<br>• [Hierarchy 정리 습관](./Day4/4-3-2.WebGL변환및GitHubPages배포가이드.md)                                                          | • [Lights(포인트·스팟), Materials(PBR)]()                                | • [Mini Task: “3D Playground” 씬 + Basic FPS Controller]() | ✔ 3D 씬 스크린샷 PR                                  |
