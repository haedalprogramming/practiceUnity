...
| **5. 3D 기초 & 씬 제작**         | • [3D 좌표계 이해](Day5/5-1.3D좌표계이해.md)<br>• [프리팹 개념과 활용](Day5/5-2.프리팹 개념과 활용.md)<br>• [Hierarchy 정리 습관](./Day4/4-3-2.WebGL변환및GitHubPages배포가이드.md)                                                          | • [Light 구성 이해 (Point/Spot)]()<br>• [Material 제작 실습 (PBR 기반)](./Day4/4-3-2.WebGL변환및GitHubPages배포가이드.md)• [씬 연출 기본 원]()                              | • [Mini Task: “3D Playground” 씬 + Basic FPS Controller]() | ✔ 3D 씬 스크린샷 PR<br>✔ PBR 머티리얼 적용 확인                                |
